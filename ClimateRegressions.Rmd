...
HWEvalues <- read.csv("HWEdat.csv") #downloading the HWE dataset that contains values for allelic richness, expected heterozygosity, and HWE p-values
View(HWEvalues)
...
theme_katie<-function(base_size = 18, base_family = "Arial"){
...
summary(lmHElog) #p=0.007319, R^2=0.06714-
