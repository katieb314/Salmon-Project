...
rastNFL <- plot(rast$bio1, xlim=c(-65,-50), ylim=c(45,58), 1, main="", xaxt="n", yaxt="n", legend=F, box=F, axes=F) #plotting the newfoundland populations to get an idea of where they are 
rastNFL
